...
// ************************** SVG utility methods ********************************************	
    ...
    var svgAttributeMap = {
        ...
        _node = function (name, attributes) {
            var n = jsPlumbAdapter.createElement(name, attributes);
            n.atts.version = "1.1";
            n.atts.xmlns = ns.xhtml;
     ...
     */
    _jp.ConnectorRenderers.headless = function (params) {
        var self = this,
    ...
    _ju.extend(_jp.ConnectorRenderers.headless, SvgComponent);

// ******************************* svg segment renderer *****************************************************	

    _jp.Segments.headless = {
        SegmentRenderer: {
...
// ******************************* /svg segments *****************************************************
     ...
     * SVG Dot Endpoint
     */
    _jp.Endpoints.headless.Dot = function () {
    ...
    _ju.extend(_jp.Endpoints.headless.Dot, [_jp.Endpoints.Dot, SvgEndpoint]);

    /*
     * SVG Rectangle Endpoint
     */
    _jp.Endpoints.headless.Rectangle = function () {
    ...
    _ju.extend(_jp.Endpoints.headless.Rectangle, [_jp.Endpoints.Rectangle, SvgEndpoint]);

    /*
     * SVG Image Endpoint is the default image endpoint.
     */
    _jp.Endpoints.headless.Image = _jp.Endpoints.Image;
    /*
     * Blank endpoint in svg renderer is the default Blank endpoint.
     */
    _jp.Endpoints.headless.Blank = _jp.Endpoints.Blank;
    /*
     * Label overlay in svg renderer is the default Label overlay.
     */
    _jp.Overlays.headless.Label = _jp.Overlays.Label;
    /*
     * Custom overlay in svg renderer is the default Custom overlay.
     */
    _jp.Overlays.headless.Custom = _jp.Overlays.Custom;
    ...
    _jp.Overlays.headless.Arrow = function () {
        AbstractSvgArrowOverlay.apply(this, [_jp.Overlays.Arrow, arguments]);
    };
    _ju.extend(_jp.Overlays.headless.Arrow, [ _jp.Overlays.Arrow, AbstractSvgArrowOverlay ]);

    _jp.Overlays.headless.PlainArrow = function () {
        AbstractSvgArrowOverlay.apply(this, [_jp.Overlays.PlainArrow, arguments]);
    };
    _ju.extend(_jp.Overlays.headless.PlainArrow, [ _jp.Overlays.PlainArrow, AbstractSvgArrowOverlay ]);

    _jp.Overlays.headless.Diamond = function () {
        AbstractSvgArrowOverlay.apply(this, [_jp.Overlays.Diamond, arguments]);
    };
    _ju.extend(_jp.Overlays.headless.Diamond, [ _jp.Overlays.Diamond, AbstractSvgArrowOverlay ]);
