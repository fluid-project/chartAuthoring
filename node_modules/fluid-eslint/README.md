...
# ESLint - Fluid Community Edition
...
This project differs from the upstream version of [ESLint](https://github.com/eslint/eslint) in that it includes a fully working fix for [issue 4931](https://github.com/eslint/eslint/issues/4931).
